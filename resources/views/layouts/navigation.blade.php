            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="https://alnaierh.com/storage/photos/webicon_1644306265.png" class="block h-10 w-auto fill-current">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('gold-transaction-form')" :active="request()->routeIs('gold-transaction-form')">
                        {{ __('فورم العمليات(البيع/الشراء)') }}
                    </x-nav-link>
                </div>
